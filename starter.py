...
# PROBLEM 3
# Create a variable that holds a boolean value representing 
...
# PROBLEM 6
# Create an array called `colors` and set it equal to a list of 
...
# Use a for-in loop to iterate over the `numbers` array, 
# and if a number is even, add  it to the `even_numbers` array.
...
# Problem 12
# Research to find the Python method that allows you to add an element
#  to the end of the array (similar to push() in JavaScript),
...
friends.insert(2, "Oaklie")
print(friends)

# Problem 15
# Remove the last item in the array 
# (try to think about how you can do this dynamically, meaning,
